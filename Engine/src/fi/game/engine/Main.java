...
/** A simple textured cube. Uses Texture from jme3-test-data library! */
    ...
    Material mat_stl2 = new Material(assetManager, "Common/MatDefs/Misc/SimpleTextured.j3md");
    ...
    Material mat_stl3 = new Material(assetManager, "Common/MatDefs/Misc/SimpleTextured.j3md");
    ...
    Material mat_stl4 = new Material(assetManager, "Common/MatDefs/Misc/SimpleTextured.j3md");
    ...
    Material mat_stl5 = new Material(assetManager, "Common/MatDefs/Misc/SimpleTextured.j3md");
    ...
    Material mat_stl6 = new Material(assetManager, "Common/MatDefs/Misc/SimpleTextured.j3md");
    ...
    Material mat_stl7 = new Material(assetManager, "Common/MatDefs/Misc/SimpleTextured.j3md");
    ...
    Material mat_stl11 = new Material(assetManager, "Common/MatDefs/Misc/SimpleTextured.j3md");
    mat_stl11.setTexture("m_ColorMap",
            assetManager.loadTexture("Textures/nkbrick.jpg"));
    cube10.setMaterial(mat_stl11);
    rootNode.attachChild(cube10);
    ...
    cube13.setLocalTranslation(new Vector3f(6,0,2));
        ...
        Material mat_stl13 = new Material(assetManager, "Common/MatDefs/Misc/SimpleTextured.j3md");
    mat_stl13.setTexture("m_ColorMap",
            assetManager.loadTexture("Textures/nkdoor.jpg"));
cube13.setMaterial(mat_stl13);
    rootNode.attachChild(cube13);
